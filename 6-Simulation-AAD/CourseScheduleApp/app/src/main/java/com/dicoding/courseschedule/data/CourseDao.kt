...
interface CourseDao {
    ...
    @Query("SELECT id, courseName, day, startTime, endTime, lecturer, note FROM course WHERE id = :id")
    fun getCourse(id: Int): LiveData<Course>

    @Query("SELECT id, courseName, day, startTime, endTime, lecturer, note FROM course WHERE day = :day")
