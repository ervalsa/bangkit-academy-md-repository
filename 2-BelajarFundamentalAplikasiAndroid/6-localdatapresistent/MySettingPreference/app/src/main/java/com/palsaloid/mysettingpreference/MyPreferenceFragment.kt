package com.palsaloid.mysettingpreference
...
class MyPreferenceFragment : PreferenceFragmentCompat(), SharedPreferences.OnSharedPreferenceChangeListener {
    ...
    private lateinit var emailPrefernce: EditTextPreference
    ...
    private fun setSummaries() {
        ...
        emailPrefernce.summary = sh?.getString(EMAIL, DEFAULT_VALUE)
    ...
    private fun init() {
        ...
        emailPrefernce = findPreference<EditTextPreference>(EMAIL) as EditTextPreference
    ...
    override fun onSharedPreferenceChanged(sharedPreferences: SharedPreferences?, key: String?) {
        ...
        if (key == EMAIL) {
            emailPrefernce.summary = sharedPreferences?.getString(EMAIL, DEFAULT_VALUE)
        }
