...
class RandomHabitAdapter(
    ...
    inner class PagerViewHolder internal constructor(itemView: View) :
        ...
        private val tvPagerTimer: TextView = itemView.findViewById(R.id.pager_tv_timer)
        private val tvPagerMinutes: TextView = itemView.findViewById(R.id.pager_tv_minutes)
        ...
        fun bind(pageType: PageType, pageData: Habit) {
            ...
            tvPagerTimer.text = pageData.startTime
            tvPagerMinutes.text = pageData.minutesFocus.toString()

            val priorityMode = when(pageType) {
            ...
            ivPriorityLevel.setImageResource(priorityMode)
